  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6">
          <h3 className="text-lg font-medium text-[#415A80] mb-4">Payment Method</h3>
          ...
          {paymentMethod === 'visa' && (
            <a
              href="https://stripe.com/docs/testing" // Replace with real Stripe link if needed
              target="_blank"
              rel="noopener noreferrer"
              className="block text-center bg-[#415A80] hover:bg-[#A5D4DC] text-white font-medium py-3 px-4 rounded-lg transition-colors mb-3"
            >
              Pay with Visa (via Stripe)
            </a>
          )}
          ...
          {paymentMethod === 'paypal' && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block text-center bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-3 px-4 rounded-lg transition-colors mb-3"
            >
              Pay with PayPal
            </a>
          )}
          ...
          {paymentMethod === 'click' && (
            <a
              href="https://your-click-payment-link.com"
              target="_blank"
              rel="noopener noreferrer"
              className="block text-center bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-4 rounded-lg transition-colors mb-3"
            >
              Pay via Click Payment
            </a>
          )}
          ...
          {paymentMethod === 'cash' && (
            <button
              ...
              disabled={processing}
              className="w-full bg-[#415A80] hover:bg-[#A5D4DC] text-white font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50"
            >
              {processing ? (
                <span className="flex items-center justify-center">
                  <Loader className="animate-spin -ml-1 mr-2 h-5 w-5" />
                ...
                `Confirm Cash Payment ($${booking.doctor?.fee || 50}.00)`
              )}
            </button>
          )}
